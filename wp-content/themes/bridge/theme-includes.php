...
/* Include activation for timetable */
include_once('includes/plugins/timetable.php');
/* Include activation for quick links */
include_once('includes/plugins/quick-links.php');
