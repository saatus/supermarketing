...
add_action( 'tgmpa_register', 'qode_register_quick_links_plugin' );
/**
 ...
 */
if (!function_exists('qode_register_quick_links_plugin')) {
	function qode_register_quick_links_plugin() {
		...
		$plugins = array(
			...
			array(
				'name'     				=> esc_html__('Quick Links', 'qode'), // The plugin name
				'slug'     				=> 'qode-quick-links', // The plugin slug (typically the folder name)
				'source'   				=> get_template_directory() . '/plugins/qode-quick-links.zip', // The plugin source
