...
if (!function_exists('qode_timetable_register_required_plugins')) {
	...
	function qode_timetable_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				'name'     				=> esc_html__('Timetable Responsive Schedule For WordPress', 'qode'), // The plugin name
	...
	add_action( 'tgmpa_register', 'qode_timetable_register_required_plugins' );
