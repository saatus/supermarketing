...
<?php } ?>
<?php if (!empty($qode_options_proya['small_button_fontsize']) || !empty($qode_options_proya['small_button_lineheight']) || !empty($qode_options_proya['small_button_fontweight']) || !empty($qode_options_proya['small_button_padding']) || $qode_options_proya['small_button_border_radius'] !== '') { ?>
	.qbutton.small{
...
<?php } ?>
<?php if (!empty($qode_options_proya['large_button_fontsize']) || !empty($qode_options_proya['large_button_lineheight']) || !empty($qode_options_proya['large_button_fontweight']) || !empty($qode_options_proya['large_button_padding']) || $qode_options_proya['large_button_border_radius'] !== '') { ?>
	.qbutton.large{
