...
$qodeFramework->qodeMetaBoxes->addMetaBox("slides_title",$qodeSlideTitle);
	...
	$qodeSlideTitle->addChild("qode_slide_title_separator_container",$qode_slide_title_separator_container);
		...
		$qode_slide_title_separator_gradient = new QodeMetaField("yesno","qode_slide_separator_gradient","no","Separator Gradient","Enable gradient for Separator");
...
$qodeFramework->qodeMetaBoxes->addMetaBox("slides_buttons",$qodeSlideButtons);
	...
	$qodeSlideButtons->addChild("button1_group",$button1_group);
	    ...
	    $button1_group->addChild("row1",$row1);
			...
			$button1_type = new QodeMetaField("select","qode_slide_button_type","","Type","This is some description", array(
				"qode-button" 		=> "Qode Button",
				"qode-button-v2"	=> "Qode Button V2",
			),
			array("dependence" => true,
				"hide" => array(
		    ...
		    $button1_hover_type = new QodeMetaField("select","qode_slide-button-hover-type","default","Hover Type","Choose animation on hover", array(
			    "default" => "Default",
			    "enlarge" => "Enlarge",
			));
...
//			$qode_slide_button_v2_hover_container->addChild("qode_slide_button_v2_hover_type",$button1_v2_hover_type);
			...
			$button_v2_icon_gradient = new QodeMetaField("yesno","qode_slide_button_v2_icon_gradient","no","Button V2 Icon Gradient","Please enable gradient for icon. This is only for Button V2 type");
...
//init icon pack hide and show array. It will be populated dinamically from collections array
	...
	$qodeSlideButtons->addChild("button2_group",$button2_group);
	    ...
	    $button2_group->addChild("row1",$row1);
			...
			$button_type2 = new QodeMetaField("select","qode_slide_button_type2","","Button 2 Type","This is some description", array(
				"qode-button" 		=> "Qode Button",
				"qode-button-v2"	=> "Qode Button V2",
			),
				array("dependence" => true,
		    ...
		    $button2_hover_type = new QodeMetaField("select","qode_slide-button-hover-type2","default","Button 2 Hover Type","Choose animation on hover", array(
			    "default" => "Default",
			    "enlarge" => "Enlarge",
			));
...
//			$qode_slide_button_v2_hover_container2->addChild("qode_slide_button_v2_hover_type2",$button2_v2_hover_type);
			...
			$button2_v2_icon_gradient = new QodeMetaField("yesno","qode_slide_button2_v2_icon_gradient","no","Button 2 V2 Icon Gradient","Please enable gradient for icon. This is only for Button V2 type");
